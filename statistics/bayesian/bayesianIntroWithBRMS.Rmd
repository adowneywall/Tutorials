...
One way to to think about the division between a frequentist and bayesian approach is to consider the underlying principle of probability as it considered in the two different methods. Here we illustrate two distinct definitions which encompass either frequentist or bayesian thought:  
